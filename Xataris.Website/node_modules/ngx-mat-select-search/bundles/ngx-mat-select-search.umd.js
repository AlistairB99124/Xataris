(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@angular/material'), require('@angular/cdk/keycodes'), require('rxjs'), require('rxjs/operators'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define('ngx-mat-select-search', ['exports', '@angular/core', '@angular/forms', '@angular/material', '@angular/cdk/keycodes', 'rxjs', 'rxjs/operators', '@angular/common'], factory) :
	(factory((global['ngx-mat-select-search'] = {}),global.ng.core,global.ng.forms,global.ng.material,global.ng.cdk.keycodes,global.rxjs,global.Rx.Observable.prototype,global.ng.common));
}(this, (function (exports,core,forms,material,keycodes,rxjs,operators,common) { 'use strict';
