import { ChangeDetectionStrategy, ChangeDetectorRef, Component, ElementRef, EventEmitter, forwardRef, Inject, Input, ViewChild, NgModule } from '@angular/core';
...
class MatSelectSearchComponent {
     ...
     */
    getWidth() {
        const /** @type {?} */ element = this.innerSelectSearch.nativeElement;
        // Need to check that the parentElement is referenced
        // because angulars change detection will run this earlier
        if (element.parentElement.parentElement) {
            const /** @type {?} */ container = element.parentElement.parentElement.parentElement;
            const /** @type {?} */ scrollbarWidth = container.offsetWidth - container.clientWidth;
...
export { MatSelectSearchComponent, NgxMatSelectSearchModule };
