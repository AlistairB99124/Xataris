...
export class LoginComponent implements OnInit
{
    ...
    resetPassword(){
        this.accountApiService.forgotPassword(this.resetForm.value).subscribe(res => {
    ...
    login(){
        ...
        this.accountApiService.login(input).subscribe(res => {
          if (res.data.isSuccess){
              localStorage.setItem('userId', res.data.id);
              this.router.navigate(['PTM/MyTimesheet']);
          } else {
            this.translateService.get(res.data.errorMessage).subscribe(result => {
    ...
    resetPasswordConfirm(){
            ...
            this.accountApiService.resetPassword(input).subscribe(res => {
                if (res.data.isSuccess) {
